/*!
 * cagdas-events.js — cagd.as behavioral-analytics bundle → window.dataLayer → GTM → GA4.
 *
 ...
 *
 * Build:   python3 scripts/site_deploy.py build --site cagdas --src cagdas-events
 * Served:  https://files.cagd.as/scripts/cagdas-events.min.js   (Webflow Footer, defer)
